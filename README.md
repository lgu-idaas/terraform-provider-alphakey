...
| 리소스 | 설명 |
|--------|------|
| [alphakey_user](docs/resources/user.md) | 사용자 등록, 수정, 삭제, ID 생성/회수 |
| [alphakey_app](docs/resources/app.md) | SaaS 앱 등록/삭제 |
| [alphakey_app_contract](docs/resources/app_contract.md) | 앱 계약정보 등록/수정 |
| [alphakey_user_group](docs/resources/user_group.md) | 사용자 그룹 CRUD + 멤버 관리 |
| [alphakey_app_group](docs/resources/app_group.md) | 앱 그룹 CRUD + 앱/사용자 관리 |
| [alphakey_user_app](docs/resources/user_app.md) | 사용자-앱 권한 부여/회수 |
| [alphakey_blocked_ip](docs/resources/blocked_ip.md) | 접속 차단 IP 관리 |
| [alphakey_admin](docs/resources/admin.md) | 일반 관리자 추가/삭제 |
| [alphakey_mfa_policy](docs/resources/mfa_policy.md) | MFA 인증수단 정책 관리 |
| [alphakey_password_expiry](docs/resources/password_expiry.md) | 비밀번호 유효기간 설정 |

## 데이터소스

| 데이터소스 | 설명 |
|-----------|------|
| [alphakey_user](docs/data-sources/user.md) | 단일 사용자 조회 |
| [alphakey_users](docs/data-sources/users.md) | 사용자 목록 조회 |
| [alphakey_app](docs/data-sources/app.md) | 단일 앱 조회 |
| [alphakey_apps](docs/data-sources/apps.md) | 앱 목록 조회 |
| [alphakey_user_groups](docs/data-sources/user_groups.md) | 사용자 그룹 목록 |
| [alphakey_app_groups](docs/data-sources/app_groups.md) | 앱 그룹 목록 |
| [alphakey_departments](docs/data-sources/departments.md) | 부서 목록 |
| [alphakey_app_categories](docs/data-sources/app_categories.md) | 앱 카테고리 목록 |
